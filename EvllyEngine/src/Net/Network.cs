        ...
        private static void AddEntityFromType(NetViewSerializer entitySerializer)
        {
            switch (entitySerializer.EntityType)
            {
                case EntityType.none:
                    Entitys.Add(entitySerializer.ViewID, new Entity(entitySerializer));
                    break;
                    ...
                    while ((inc = Server.ReadMessage()) != null)
                    {
                        switch (inc.MessageType)
                        {
                            ...
                            case NetIncomingMessageType.ErrorMessage:
                                ...
                                {
                                    OnPlayerDisconnect.Invoke(inc.SenderConnection);
                                }
                                break;
                            ...
                            default:
                                ...
                                {
                                    OnPlayerConnect.Invoke(inc.SenderConnection);
